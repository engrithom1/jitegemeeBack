...
class Student extends Model
{
    ...
    protected $fillable = ['parent_status_id','religion','birth_place','former_school','student_status_id','hearth','admission','entry','school_from','relation_to','transfer_reason','parent_id','user_id','level_id','classroom_id','accademic_year','regist_year','nationality','birth_date','behavior','first_name','middle_name','last_name','gender','phone','photo','home_address','email','index_no','prem_no'];
