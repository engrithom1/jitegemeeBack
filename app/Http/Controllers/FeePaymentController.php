...
class FeePaymentController extends Controller
{
    ...
    public function getStudentByIndexNo(Request $request)
    {
        ...
        $student = DB::table('students')
                          ...
                          ->select('students.id','students.admission','students.index_no','students.first_name','students.middle_name','students.last_name','students.classroom_id','students.level_id')
    ...
    public function checkRequiredFees(Request $request)
    {
        ...
        $fz = explode(',',$fees);
        $feepay = FeePayment::where(['year' => $year, 'classroom_id' => $class_id, 'level_id' => $level_id, 'student_id' => $student_id])->get();
